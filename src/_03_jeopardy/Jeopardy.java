...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("Which country has the longest coastline?", "Canada", 200);
			firstButton.setText("");
		}
...
askQuestion("Utah's Great Salt Lake is the largest remnant of what enormous prehistoric lake?", "Lake Bonneville", 400);
...
secondButton.setText("");
		...
		if (buttonPressed == thirdButton) {
			askQuestion("What is the capital of Greece?", "Athens", 600);
			thirdButton.setText("");
		}
		if (buttonPressed == fourthButton) {
			askQuestion("Who is C3-PO'ssidekick?", "R2-D2", 800);
